...
CONFIG = {
    ...
    'RESPONSE_INTERVAL': 2,  # Interval in seconds to simulate user response time
    'NUM_SESSIONS': 5,  # Number of sessions to run concurrently
    'INSTANCE_START_DELAY': 1,  # Delay in seconds between starting each instance
